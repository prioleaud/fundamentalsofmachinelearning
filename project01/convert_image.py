...
image_Folder_Path = 'handwritten_data/images' #your path to target folder to save images. Note: Path should have 26 empty folder with name as alphabets
...
with open(csv_File_Path, newline='') as csvfile:
    ...
    for row in reader:
        ...
        image_Path = image_Folder_Path + '\\' + str(last_digit_Name) + '-' + str(count) + '.png'
