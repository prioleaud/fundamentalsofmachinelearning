...
combinedLabels = np.concatenate((trainLabels_2,trainLabels_1),axis=0)
...
for i in range(len(test_predictions)):
    if(test_predictions[i] == 1):
        if(np.amax(dist[0][i],axis=0) > thresholds[0]):
            test_predictions[i] = -1
    elif(test_predictions[i] == 2):
        if(np.amax(dist[0][i],axis=0) > thresholds[1]):
            test_predictions[i] = -1
    elif(test_predictions[i] == 3):
        if(np.amax(dist[0][i],axis=0) > thresholds[2]):
            test_predictions[i] = -1
    elif(test_predictions[i] == 4):
        if(np.amax(dist[0][i],axis=0) > thresholds[3]):
            test_predictions[i] = -1
    elif(test_predictions[i] == 5):
        if(np.amax(dist[0][i],axis=0) > thresholds[4]):
            test_predictions[i] = -1
    elif(test_predictions[i] == 6):
        if(np.amax(dist[0][i],axis=0) > thresholds[5]):
            test_predictions[i] = -1
    elif(test_predictions[i] == 7):
        if(np.amax(dist[0][i],axis=0) > thresholds[6]):
            test_predictions[i] = -1
    elif(test_predictions[i] == 8):
        if(np.amax(dist[0][i],axis=0) > thresholds[7]):
            test_predictions[i] = -1
#    if(np.amax(dist[0][i],axis=0) > thresholds[0] or np.amax(dist[0][i],axis=0) > thresholds[1] or 
#       np.amax(dist[0][i],axis=0) > thresholds[2] or np.amax(dist[0][i],axis=0) > thresholds[3] or
#       np.amax(dist[0][i],axis=0) > thresholds[4] or np.amax(dist[0][i],axis=0) > thresholds[5] or
#       np.amax(dist[0][i],axis=0) > thresholds[6] or np.amax(dist[0][i],axis=0) > thresholds[7]):
#        test_predictions[i] = -1
